...
<body>
	...
	<div class="wishlistBox"
		style="display: none; left: 550px; top: 200px;">
		<div class="personRigTop persongBgimg"
					...
					<table class="x-form-table">
						<tbody>
							<tr class="line">
								...
								<td width="90%"><input class="normal-input"
									name="oldPassword" id="oldPassword" style="width: 240px;"
									type="password" /></td>
							</tr>
							<tr class="line">
								<td class="left"><label><em class="required">*</em>新密码：</label></td>
								<td><input class="normal-input" name="newPassword"
									id="newPassword" style="width: 240px;" type="password" /></td>
							</tr>
							<tr class="line">
								<td class="left"><em class="required">*</em><label>确认新密码：</label></td>
								<td><input class="normal-input" name="newPasswordAgain"
									id="newPasswordAgain" style="width: 240px;" type="password" />
								</td>
							</tr>
							<tr>
								<td class="left"></td>
								<td class="submit"><input id="submitVal" class="tabSub"
									value="提交"
									onclick="checkForm('http://127.0.0.1:8081/SSMDemo');"
									type="button" /> <input class="tabSub" value="关闭"
									onclick="closeDiv();" type="reset" /></td>
							</tr>
						</tbody>
					</table>
				</form>
		...
		<div id="header">
			<div class="iheader">
				...
				<div style="height: 44px;">
					...
					<div class="h_info">
						<span class="line"></span> 欢迎您！姓名[账号]&nbsp;
						当前时间：2017年03月20日&nbsp;&nbsp;&nbsp;&nbsp; <a
							href="javascript:void(0);" onclick="openAddDiv();">[修改密码]</a>
						&nbsp; <a href="javascript:void(0);"
							onclick="if(confirm('您确认退出系统?')){};">[退出系统]</a>
					</div>
				</div>
				...
				<tbody>
					<tr>
						<td class="leftTd" style="vertical-align: top" width="150">
							<div class="left">
								<div class="ileft" id="menuDiv">
									<h3 onclick="$('#mainPage').attr('src','${basePath}/ad');">
										<a>广告管理</a>
									</h3>
								</div>
								<div class="ileft" id="menuDiv">
									<h3 onclick="$('#mainPage').attr('src','${basePath}/businesses');">
										<a>商户管理</a>
									</h3>
								</div>
							</div>
						...
						<td style="vertical-align: top" height="600px" width="100%">
							<br /> <iframe id="mainPage" src="" frameborder="0"
								height="580px" width="100%"></iframe><br/>
						</td>
					</tr>
				</tbody>
			</table>
